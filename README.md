...
With the branch-write-protection plugin, write protection for branches can be set separately for each repository.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-branchwp-plugin/docs).
